...
const App: React.FC = () => {
  ...
  const renderView = () => {
    switch (activeView) {
      ...
      case AppView.SCRIPT: return <ScriptGenerator />;
      case AppView.COPY: return <CopyAssistant />;
      case AppView.XHS_NOTE: return <NoteLab />;
  ...
  return (
    <div className="flex h-screen bg-[#F5F6F7] text-[#1F2329] overflow-hidden">
      {/* Sidebar */}
      <aside 
        className={`${sidebarCollapsed ? 'w-[64px]' : 'w-[240px]'} bg-[#1F2329] flex flex-col transition-all duration-300 z-50`}
      >
        ...
        <header className="h-[60px] bg-white border-b border-[#E4E5E7] flex items-center justify-between px-6 shrink-0 z-40">
          ...
          <div className="flex items-center space-x-5">
            ...
            <div className="flex items-center space-x-2 pl-2 border-l border-gray-200">
              ...
              <span className="text-sm font-medium hidden sm:inline-block">奥迪门店专家</span>
            </div>
          </div>
        </header>
